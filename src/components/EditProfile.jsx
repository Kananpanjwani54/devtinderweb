...
import SwipeCard from "./userCard";
import { useDispatch } from "react-redux";
import api from "../utils/api"; // 1. IMPORT YOUR NEW API INSTANCE
import { addUser } from "../utils/userSlice";
...
const EditProfile = ({ user = {} }) => {
  ...
  const saveProfile = async () => {
    ...
    try {
      // 2. USE 'api' INSTEAD OF 'axios' and remove BASE_URL + withCredentials
      const res = await api.patch(
        "/profile/edit", // The base URL is already part of the 'api' instance
        {
          firstName,
          lastName,
          profilePic,
